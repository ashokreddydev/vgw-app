...
app.post('/api/history', (req, res) => {
    ...
    const URL = `https://api-sepolia.etherscan.io/api?module=account&action=txlist&address=${req.body.address}&startblock=0&endblock=99999999&sort=desc&apikey=48155D87J73SYAU8WQ4KKH4AQ4VS5MHY4Q`
